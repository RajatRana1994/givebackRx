...
public class CardValidator {
    ...
    public enum Cards {
        ...
        MASTERCARD("mastercard", "^5[0-5][0-9]{14}$", DEFAULT_CARD_FORMAT, new int[]{16,17}, new int[]{3}, true, true), //check supported
    ...
    public static boolean validateExpiryDate(int month, int year) {
        ...
        return (curYear == year) ? curMonth <= month : curYear < year&&month<=12;
    }
