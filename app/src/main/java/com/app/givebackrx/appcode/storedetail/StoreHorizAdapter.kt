...
class StoreHorizAdapter(
    val mCategoryList: MutableList<SimilarProduct>, val clickItem: (Int) -> Unit
) : RecyclerView.Adapter<StoreHorizAdapter.VHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VHolder {
        return VHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.row_store_item_horiz, parent, false)
        )
    }
