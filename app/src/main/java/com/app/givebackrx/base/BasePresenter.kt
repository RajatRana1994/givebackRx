...
import com.app.givebackrx.data.network.RestService
...
constructor(
    ...
    private val compositeDisposable: CompositeDisposable, private val apiHelper: ApiHelper
) : MvpPresenter<V> {
...
//            dataManager.setKeyValue(PreferenceConstants.TOKENTYPE, it.token_type)
    ...
    fun handleError(e: Throwable, lastAction: String) {
        e.printStackTrace()
        try {
            mvpView!!.hideLoading()
...
//                    mvpView!!.showErrorMessage(getErrorMessage(responseBody))
    ...
    public fun getErrorMessage(responseBody: okhttp3.ResponseBody?): String {
        try {
